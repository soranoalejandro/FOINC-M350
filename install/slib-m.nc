...
WHILE [#[1520+#4-1] != #6] DO1   
#1510 = #4
#1503 = 1(Waiting tool magazine extend.. [IN%.0f])
G04 P10
END1 
N30
M99
...
WHILE [#[1520+#4-1] != #6] DO1   
#1510 = #4
#1503 = 1(Waiting tool magazine retract.. [IN%.0f])
G04 P10
END1 
N30
M99
...
WHILE [#[1520+#4-1] != #6] DO1  
#1510 = #4 
#1503 = 1(Dust cover open detection.. [IN%.0f])
G04 P10
END1 
N30
M99
...
WHILE [#[1520+#4-1] != #6] DO1   
#1510 = #4
#1503 = 1(Dust cover closed detection.. [IN%.0f])
G04 P10
END1 
N30
M99
...
WHILE [#[1520+#4-1] != #6] DO1   
#1510 = #4
#1503 = 1(Waiting servo position complete signal.. [IN%.0f])
G04 P10
END1 
N30
M99
